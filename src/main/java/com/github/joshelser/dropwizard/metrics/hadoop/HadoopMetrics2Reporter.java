...
public class HadoopMetrics2Reporter extends ScheduledReporter implements MetricsSource {
  ...
  private static final SortedMap<String,Gauge> EMPTY_GAUGE_MAP = Collections.unmodifiableSortedMap(new TreeMap<String,Gauge>());
  private static final SortedMap<String,Meter> EMPTY_METER_MAP = Collections.unmodifiableSortedMap(new TreeMap<String,Meter>());
  private static final SortedMap<String,Timer> EMPTY_TIMER_MAP = Collections.unmodifiableSortedMap(new TreeMap<String,Timer>());
  private static final SortedMap<String,Counter> EMPTY_COUNTER_MAP = Collections.unmodifiableSortedMap(new TreeMap<String,Counter>());
  private static final SortedMap<String,Histogram> EMPTY_HISTOGRAM_MAP = Collections.unmodifiableSortedMap(new TreeMap<String,Histogram>());
  ...
  @SuppressWarnings("rawtypes") SortedMap<String, Gauge> getDropwizardGauges() {
